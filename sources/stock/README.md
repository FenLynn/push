...
The `stock` workflow is scheduled at 11:30 and 15:05 Beijing time on weekdays and
also supports manual dispatch. The module's exchange-day check prevents holiday runs
from overwriting the latest valid trading snapshot.
...
When at least 1,000 rows have a valid percentage change and both statistics are valid, the workflow overwrites
